                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <br>
                                    ...
                                    <p>Nomor : {{$per_no}} </p>
                                    <p>Tujuan perjalanan : <?php $tmp = '';
                                                 for ($i=0; $i < count($kota); $i++) { 
                                                    if ($i!=count($kota)-1 && $kota[$i] != $tmp) {
                                                        echo $kota[$i];
                                                        echo ' - ';
                                                    }
                                                }
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <ul class="nav nav-pills navtab-bg nav-justified mb-3">
                                                    <li class="nav-item">
                                                        <a href="#datatj" data-toggle="tab" aria-expanded="false" class="nav-link active">
                                                            Kota Tujuan
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
                                                ...
                                                <div class="tab-content">
                                                    <div class="tab-pane active" id="datatj">
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="timeline">
                                                                                ...
                                                                                <div class="timeline-box perj-box">
                                                                                    ...
                                                                                    <div class="row">
                                                                                        <div class="col-md-3">
                                                                                            ...
                                                                                            <input required autocomplete="off" placeholder="Nama kota" id="per_tujuan_1" class="form-control per_tujuan"  name="kt_nama[]" type="text">
                                                                                        ...
                                                                                        <div class="col-md-3">
                                                                                            <input type="text" value="0" class="form-control bbm" name="per_bbm[]" placeholder="Biaya BBM" id="bbm_1"  type="text">
                                                    ...
                                                    <div id="newBiaya">
                                                        <div class="form-group newB" id="b_1">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="row">
                                                                    <div class="col-md-5">
                                                                        <input readonly type="text" placeholder="Nama biaya" data-precision="0" data-thousands=" " data-prefix="Rp "  
